...
> 📦 **アーカイブ文書** (2025-12 時点のスナップショット。現行情報は [README.md](../README.md) 参照)

> **最新の引き継ぎ**: [HANDOVER_2026-06-10.md](./HANDOVER_2026-06-10.md)（戦略ドキュメント追加・全体レビュー/バグ修正・PR #43）を参照。
> 本資料は 2025年12月時点のスナップショットであり、一部（プッシュ通知=実装済み 等）は古くなっています。
